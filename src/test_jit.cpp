...
struct AssemblerTest_MOV : public AssemblerTestFixture{ bool test(){
...
struct AssemblerTest_GPR_INSTR : public AssemblerTestFixture{
...
bool test(){
#define R64FX_LIST7(a) a,a,a,a,a,a,a
#define R64FX_TEST_GPR_INSTR(name, op) test_gpr_inst<R64FX_LIST7(&Assembler::name)>(#name, [](int a, int b){ return a op b; })
    return
        R64FX_TEST_GPR_INSTR(ADD, +) &&
        R64FX_TEST_GPR_INSTR(SUB, -) &&
        R64FX_TEST_GPR_INSTR(XOR, ^) &&
...
#define R64FX_TEST(INSTR) (AssemblerTest_##INSTR().test()) &&
