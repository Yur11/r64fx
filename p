...
DEFAULT_PROJECT_COMPILER="g++ -std=c++11 -g -O0"

DEFAULT_DEFS="-DR64FX_DEBUG -DR64FX_USE_X11 -DR64X_DEBUG_GL_ERRORS -DR64X_ABORT_ON_GL_ERROR"
...
then
    PROJECT_COMPILER="$DEFAULT_PROJECT_COMPILER"
